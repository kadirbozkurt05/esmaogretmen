...
const ProfileCard = () => {
  ...
  const {performFetch, error, isLoading } = useFetch(`/user/${user._id}`,onSuccess);
  ...
  return (
    <div className="w-full bg-gray-50 flex justify-center items-center">
      ...
      <input type='file' id='file' accept="image/*" onChange={handleImageChange} ref={inputFile} style={{display: 'none'}}/>

      <div   className="relative">
        <img src={user?.picture} alt="aji" className=" w-20 h-20 object-cover rounded-full"/>
