...
const ApplyForm = () => {
  ...
  return (
    <div className="grid max-w-screen-lg mx-auto sm:grid-cols-2 items-center gap-16 p-8 bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
      <div>
        <h1 className="text-3xl font-extrabold">Ders Talebi Oluştur</h1>
        <p className="text-sm text-gray-400 mt-3">
          Lütfen yandaki bilgileri doldurunuz. Sizinle 24 saat içinde iletişime
          geçeceğim.
        </p>
        <div className="mt-12">
          <h2 className="text-lg font-extrabold">Plan</h2>
