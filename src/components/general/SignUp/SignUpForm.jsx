...
const SignUpForm = () => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex overflow-scroll md:py-32 justify-center items-center  bg-black bg-opacity-50 z-40">
        <form
          className="bg-white rounded-md w-full mt-64 md:w-3/4 md:p-10 p-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] text-[#333] font-[sans-serif]"
          onSubmit={handleSubmit}
        >
          {" "}
          <div
            onClick={() => refreshUser()}
            className="flex cursor-pointer justify-end mt-6"
          >
            X
          </div>
