...
const ContactForm = () => {
  ...
  const { error, loading, performFetch } = useFetch("/contact", onSuccess);
  ...
  return (
    <>
      {showModal && (
        <Modal
          title={"Mesaj"}
          text={"Mesajınız iletilmiştir. En kısa sürede size dönüş yapacağım."}
        />
      )}
      <div className="grid max-w-screen-lg mx-auto sm:grid-cols-2 items-center gap-16 p-8 bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
        <div>
          <h1 className="text-3xl font-extrabold">Sorunuz mu var?</h1>
          <p className="text-sm text-gray-400 mt-3">
            Dilediğiniz her konuda soru sormak için aşağıdaki seçeneklerden
            ...
            <ul className="mt-3">
              <li className="flex items-center">
                ...
                >
                  ...
                  <strong>sogretmeni1@gmail.com</strong>
                </a>
              </li>
            </ul>
          </div>
          <div className="mt-12">
            ...
            <ul className="flex mt-3 space-x-4">
              ...
              <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a
                  target="_blank"
                  href="https://www.instagram.com/esmaogretmen35"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
