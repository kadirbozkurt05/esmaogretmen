      ...
      <nav className="bg-white border-gray-200 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            {isClicked ? (
              <div
                className="absolute z-50 top-10 transition right-0 xl:right-36 my-4 w-48 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow "
                id="user-dropdown"
              >
          ...
          >
            {!user ? (
              ...
              <div className=" bg-gray-800 border border-gray-800 shadow-lg rounded-2xl text-gray-100 font-medium p-4 justify-center flex">
                <h6 className="text-l font-semibold text-white w-96 text-center">
                  {title}
                </h6>
              </div>
            )}
