    ...
    <div className="px-3 md:px-48 py-6 bg-black text-white">
      <div className=" flex flex-col gap-6 items-center md:gap-32 justify-between  md:flex-row">
        ...
        <div className="w-full sm:w-5/12">
          <form className="flex border border-cyan-900 rounded-full bg-slate-800 px-4 py-2 focus-within:ring-2 focus-within:ring-cyan-600 hover:ring-2 hover:ring-cyan-600">
            <input className="w-full text-black p-2 appearance-none bg-slate-800 focus:outline-none" />
            <button
